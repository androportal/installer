...
busybox  chroot  /data/local/linux /bin/bash -c "service apache2 stop"
busybox  chroot  /data/local/linux /bin/bash -c "killall Xvfb"                                           
busybox  chroot  /data/local/linux /bin/bash -c "killall shellinaboxd"                                           
